class AppStrings {
  // App
  static const String appName = 'toko pierre';
  // fungsinya supaya aku bisa pake nama aplikasi
  // yang konsisten di seluruh aplikasi,
  // jadi kalo misalnya aku mau ganti nama aplikasi,
  // aku tinggal ganti di sini aja, gak perlu ganti di banyak tempat
  // Auth
